...
@section('content')
    <div class="bg-white p-6 rounded shadow">
        <h1 class="text-2xl font-bold mb-4">Редактировать участок</h1>
        <form action="{{ route('admin.sections.update', $section) }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="name" id="name" class="mt-1 block w-full border rounded p-2" value="{{ old('name', $section->name) }}">
            </div>
