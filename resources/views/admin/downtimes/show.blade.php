...
@section('content')
    <div class="bg-white p-6 rounded shadow">
        ...
        <p><strong>Причина:</strong> {{ $downtime->reason }}</p>
        <div class="flex space-x-2">
            <a href="{{ route('admin.downtimes.edit', $downtime) }}" class="bg-green-500 text-white px-4 py-2 rounded hover:bg-green-600 flex items-center">
