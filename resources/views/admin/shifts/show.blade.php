...
@section('content')
    <div class="bg-white p-6 rounded shadow">
        ...
        <p><strong>Участок:</strong> {{ $shift->section->name ?? '-' }}</p>
        <div class="flex space-x-2">
            <a href="{{ route('admin.shifts.edit', $shift) }}" class="bg-green-500 text-white px-4 py-2 rounded hover:bg-green-600 flex items-center">
