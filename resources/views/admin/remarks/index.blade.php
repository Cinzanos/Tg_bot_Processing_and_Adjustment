            ...
            @foreach ($remarks as $remark)
                <tr class="border-t hover:bg-gray-100">
                    ...
                    <td class="border p-2 space-x-2">
                        ...
                        <a href="{{ route('admin.remarks.edit', $remark) }}" class="inline-flex items-center text-green-500 hover:underline">
                            <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                                <path d="M11 5H6a2 2 0 00-2 2v12a2 2 0 002 2h12a2 2 0 002-2v-5M18.5 2.5a2.121 2.121 0 113 3L12 15l-4 1 1-4 9.5-9.5z" />
                            </svg>
                            Редактировать
                        </a>
                        <form action="{{ route('admin.remarks.destroy', $remark) }}" method="POST" class="inline">
                            @csrf
                            @method('DELETE')
